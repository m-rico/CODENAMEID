		...
		<div class="wrapper">
				...
				<nav class="navbar navbar-default" role="navigation">
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="#"><img class="img-responsive" src="images/LaundryCahayaLogo.png" width="60" height="60" alt="Logo" /></a>
						</div>

						<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="FormPendaftaran.php">Signup</a></li>
			...
			<div class="banner">
				<div class="container">
					...
					<h2>Laudry Cahaya</h2>
					<!-- paragraph -->
					<p> Jasa Laundry dan Dry Clean Terpercaya </p>
				</div>
			</div>
			<!-- banner end --> 
